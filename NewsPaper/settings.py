...
EMAIL_PORT = 587  # google
# EMAIL_PORT = 465
# EMAIL_HOST_USER = os.environ.get('HOST_USER')  # GOOGLE
# EMAIL_HOST_PASSWORD = os.environ.get('HOST_PASSW')  # GOOGLE
EMAIL_HOST_USER = os.environ.get('HOST_YANDEX')  # ваш QQ Номер счета и код авторизации
...
# syntax details. Default: 'N j, Y, P' (e.g. Feb. 4, 2003, 4 p.m.)
